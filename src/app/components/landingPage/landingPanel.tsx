...
export function LandingPanel({countryCode = "pl"}:{countryCode: keyof typeof Localization}){
    ...
    return(
      <div className={`${mounted ? "opacity-100" : "opacity-0 translate-y-1/2"} overflow-clip max-w-6xl md:px-16 mx-auto w-full lg:pt-12 rounded-xl flex flex-col gap-4 transition-all duration-500`}>
