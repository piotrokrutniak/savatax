  ...
  return (
    <>
      <section className="w-full h-screen-1/2 bg-black relative text-white">
        <div id="top-picks-section" className="max-w-7xl absolute p-8 w-full mx-auto z-30 m-auto md:text-3xl bottom-0">
            <h1 className="font-bold md:w-1/2 ">Zaufaj profesjonalistom w dziedzinie rachunkowości</h1>
            <h2 className="font-normal md:w-1/2 ">
        ...
        <div className="w-full h-full top-0 z-0">
          <Image loading="lazy" layout="fill" objectFit="cover" src={SplashArt} alt="Album thumbnail" className=" opacity-80 relative w-full h-full"/>
        </div>
      </section>
