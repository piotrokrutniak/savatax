...
export default function Home() {
  return (
    <>
      <section className="w-full h-screen-1/2 bg-gradient-to-t from-black to-slate-300 relative text-white">
        <div id="top-picks-section" className="max-w-7xl absolute p-8 w-full mx-auto z-30 m-auto bottom-0 flex flex-col gap-4">
        ...
        <div className="w-full h-full top-0 z-0">
          <Image loading="lazy" layout="fill" objectFit="cover" src={SplashArt} alt="Album thumbnail" className="opacity-70 relative w-full h-full"/>
        </div>
      </section>
