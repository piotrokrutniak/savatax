      ...
      <section id="summary-section" className='max-w-6xl mx-auto w-full justify-center md:p-16 md:py-32 rounded-xl flex flex-col gap-5'>
            ...
            <p className="pt-16">
              ...
              <ul className="md:text-lg pl-6 pt-4 gap-3 grid grid-auto-fit-md">
                <ListPanel> 
                  <FaBook className="w-14 h-14 pb-3 fill-blue-300"/> <p className="capitalize-first">prowadzenie księgowości i sprawozdawczości finansowej</p>
                </ListPanel>
                <ListPanel>sporządzanie deklaracji podatkowych i rozliczeń z urzędami skarbowymi</ListPanel>
                <ListPanel>doradztwo podatkowe i optymalizacja podatkowa</ListPanel>
                <ListPanel>analiza finansowa i planowanie budżetowe</ListPanel>
                <ListPanel>doradztwo prawne i obsługa umów</ListPanel>
              </ul>
            </p>
