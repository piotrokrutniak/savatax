    ...
    <div className="flex flex-col gap-4">
      ...
      <section id="summary-section" className='max-w-6xl mx-auto w-full justify-center md:p-16 md:py-32 rounded-xl flex flex-col gap-5'>
            ...
            <p className="pt-16">
              ...
              <ul className="md:text-lg pl-6 py-8 gap-3 grid grid-auto-fit-md">
                <ListPanel> 
                  <FaBook className="w-14 h-14 pb-3 fill-blue-400"/> <p className="capitalize-first">prowadzenie księgowości i sprawozdawczości finansowej</p>
                </ListPanel>
                <ListPanel> 
                  <FaBook className="w-14 h-14 pb-3 fill-blue-400"/> <p className="capitalize-first">sporządzanie deklaracji podatkowych i rozliczeń z urzędami skarbowymi</p>
                </ListPanel>
                <ListPanel> 
                  <FaBook className="w-14 h-14 pb-3 fill-blue-400"/> <p className="capitalize-first">doradztwo podatkowe i optymalizacja podatkowa</p>
                </ListPanel>
                <ListPanel> 
                  <FaBook className="w-14 h-14 pb-3 fill-blue-400"/> <p className="capitalize-first">analiza finansowa i planowanie budżetowe</p>
                </ListPanel>
                <ListPanel> 
                  <FaBook className="w-14 h-14 pb-3 fill-blue-400"/> <p className="capitalize-first">doradztwo prawne i obsługa umów</p>
                </ListPanel>
              </ul>
            </p>
...
function ListPanel({children}:{children: React.ReactNode}){
  return(
    <div className="shadow-md shadow-black/30 rounded-lg p-8 bg-slate-200/10 flex justify-between gap-4 ">
      {children}
    </div>
  )
}