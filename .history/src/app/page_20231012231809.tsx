  ...
  return (
    <>
      <section className="w-full h-screen-1/2 bg-gradient-to-t from-black to-black/70 relative text-white">
        <div id="top-picks-section" className="absolute p-12 w-full mx-auto z-30 m-auto bottom-0 flex flex-col gap-4">
            <div className='max-w-7xl bg-black/90 mx-auto w-full md:p-8 rounded-xl shadow-md shadow-black/40 flex-col'>
              <h1 className="font-bold md:w-1/2 md:text-4xl max-w-7xl">Zaufaj profesjonalistom w dziedzinie rachunkowości</h1>
              <h2 className="font-semibold opacity-90 md:w-1/2 text-2xl max-w-7xl">
        ...
        <div className="w-full h-full top-0 z-0">
          <Image loading="lazy" layout="fill" objectFit="cover" src={SplashArt} alt="Album thumbnail" className="opacity-50 relative w-full h-full"/>
        </div>
      </section>
