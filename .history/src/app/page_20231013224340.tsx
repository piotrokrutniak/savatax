...
export default function Home() {
  ...
  return (
    <div className="flex flex-col relative -top-20 gap-4">
      <section className="w-full h-screen-3/5 bg-gradient-to-t top-0 from-black to-black/90 relative text-white">
        <div id="slider-section" className="absolute  max-md:px-4 py-8 w-full mx-auto z-10 m-auto bottom-0 shadow-md shadow-black/40 h-full flex place-items-end lg:place-items-center">
            <div className='max-w-6xl md:px-16 mx-auto w-full rounded-xl flex flex-col gap-4'>
              <h1 className="font-bold md:w-1/2 text-xl sm:text-2xl lg:text-4xl max-w-6xl">{Localization['pl-PL'].lblSliderHeader}</h1>
              <h2 className="opacity-90 lg:w-1/2 sm:text-lg md:text-xl max-w-6xl md:leading-8">
                {Localization['pl-PL'].lblSliderP1}
                <br/>
                {Localization['pl-PL'].lblSliderP2}
              </h2>
      ...
      <section id="summary-section" className='max-w-6xl p-4 sm:p-8 mx-auto w-full justify-center md:p-16 md:py-32 rounded-xl flex flex-col gap-5'>
            <h1 className="md:text-3xl text-2xl font-bold text-blue-400 md:p-4">Rachunkowość bez stresu</h1>
            ...
            <p className="md:text-xl font-semibold pt-8" >
              Nie zwlekaj - skorzystaj z naszej oferty już dziś i zobacz, jak możemy ułatwić Ci prowadzenie Twojego biznesu. 
            </p>
            <p className="md:text-xl text-lg text-blue-400 font-bold pt-4" >
            Rachunkowość bez stresu - to nasza dewiza!
            </p>
      </section>
    </div>
  )
