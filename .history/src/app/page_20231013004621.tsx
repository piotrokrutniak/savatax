      ...
      <section id="summary-section" className='max-w-6xl mx-auto w-full justify-center md:p-16 md:py-32 rounded-xl flex flex-col gap-5'>
            ...
            <p className="pt-16">
              ...
              <ul className="md:text-lg pl-6 pt-4 gap-3 grid grid-auto-fit-md">
                <ListPanel> <FaBook className="w-14 h-14"/> prowadzenie księgowości i sprawozdawczości finansowej</ListPanel>
...
function ListPanel({children}:{children: React.ReactNode}){
  return(
    <div className="shadow-md rounded-lg p-8 bg-slate-200/10 flex justify-between gap-4 capitalize-first">
      {children}
    </div>
  )
}