      ...
      <section id="contact-section" className='max-w-6xl p-4 sm:p-8 mx-auto w-full justify-center md:px-16 rounded-xl flex flex-col gap-5'>
        <div className="flex flex-col sm:justify-between sm:place-items-center">
          ...
          <a href={"mailto:karol.zach@savatax.com"}>
            <h2 className="md:text-xl text-lg text active:opacity-80 border-b-2 pb-0 border-black hover:border-blue-400 font-semibold hover:text-blue-400 cursor-pointer transition-all w-fit flex">
