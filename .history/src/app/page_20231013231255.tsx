...
export default function Home() {
  ...
  return (
    <div className="flex flex-col relative -top-20 gap-12">
      ...
      <section id="summary-section" className='max-w-6xl p-4 sm:p-8 mx-auto w-full justify-center md:px-16 md:pt-32 rounded-xl flex flex-col gap-5'>
      ...
      <section id="summary-section" className='max-w-6xl p-4 sm:p-8 mx-auto w-full justify-center md:p-16 rounded-xl flex flex-col gap-5'>
