      ...
      <section className="w-full h-screen-1/2 bg-gradient-to-t from-black to-black/90 relative text-white">
        <div id="slider-section" className="absolute max-md:px-8 py-8 w-full mx-auto z-10 m-auto bottom-0 shadow-md shadow-black/40">
            <div className='max-w-6xl md:px-16 mx-auto w-fullrounded-xl flex flex-col gap-4'>
              <h1 className="font-bold md:w-1/2 text-xl sm:text-2xl md:text-4xl max-w-6xl">Zaufaj profesjonalistom w dziedzinie rachunkowości</h1>
              <h2 className="font-semibold opacity-90 md:w-1/2 sm:text-lg md:text-xl max-w-6xl">
