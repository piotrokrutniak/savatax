...
import { FaBook, FaChartArea, FaChartBar, FaChartLine, FaChartPie, FaCoins, FaFileInvoice, FaFileInvoiceDollar, FaGavel, FaMoneyBill, FaMoneyBillAlt, FaMoneyCheck, FaPiggyBank } from 'react-icons/fa'
      ...
      <section id="summary-section" className='max-w-6xl mx-auto w-full justify-center md:p-16 md:py-32 rounded-xl flex flex-col gap-5'>
            ...
            <p className="pt-16">
              ...
              <ul className="md:text-lg pl-6 py-8 gap-6 grid grid-auto-fit-md">
                ...
                <ListPanel> 
                  <FaGavel className="w-8 h-8 fill-blue-400 shrink-0 mt-1"/> <p className="capitalize-first">doradztwo prawne i obsługa umów</p>
                </ListPanel>
              </ul>
            </p>
