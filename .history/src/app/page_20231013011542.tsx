...
export default function Home() {
  return (
    <div className="flex flex-col gap-4">
      <section className="w-full h-screen-3/5 bg-gradient-to-t from-black to-black/90 relative text-white">
        <div id="slider-section" className="absolute max-md:px-8 py-8 w-full mx-auto z-10 m-auto bottom-0 shadow-md shadow-black/40">
            <div className='max-w-6xl md:px-16 mx-auto w-fullrounded-xl flex flex-col gap-4'>
              ...
              <h2 className="font-semibold opacity-90 lg:w-1/2 sm:text-lg md:text-xl max-w-6xl">
      ...
      <section id="summary-section" className='max-w-6xl p-8 mx-auto w-full justify-center md:p-16 md:py-32 rounded-xl flex flex-col gap-5 leading-7'>
            ...
            <p className="pt-16">
              <span className="md:text-2xl font-semibold opacity-90 p-4">
              Nasza oferta obejmuje między innymi:
              </span>
              <ul className="md:text-lg p-12 my-12 rounded-md shadow-inner gap-6 grid grid-auto-fit-md bg-sky-100/30">
                <ListPanel> 
...
function ListPanel({children}:{children: React.ReactNode}){
  return(
    <div className="shadow-md shadow-black/20 rounded-lg p-8 flex justify-between gap-4 bg-white">
      {children}
    </div>
  )
}