...
export default function Home() {
  return (
    <div className="flex flex-col gap-4">
      ...
      <section id="top-picks-section" className='max-w-7xl mx-auto w-full md:p-8 rounded-xl flex flex-col gap-5'>
            <h1 className="md:text-4xl font-bold text-blue-400">Rachunkowość bez stresu</h1>
            <span className="md:text-xl font-semibold opacity-80">
