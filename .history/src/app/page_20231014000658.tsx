    ...
    <div className="flex flex-col relative -top-20 gap-32">
      ...
      <section id="summary-section" className='max-w-6xl p-4 sm:p-8 mx-auto w-full justify-center md:px-16 rounded-xl flex flex-col gap-5'>
        <div className="flex justify-between place-items-center">
          ...
          <h2 className="md:text-xl text-lg text active:opacity-80 border-b-2 pb-0 border-black hover:border-blue-400 font-semibold hover:text-blue-400 cursor-pointer transition-all flex">Napisz bezpośrednio <FaEnvelope className="ml-2 mt-1"/> </h2>
        </div>
        <EmailForm/>
      </section>
    </div>
