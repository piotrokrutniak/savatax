...
export default function PostList(){
    ...
    return(
        <div className="text-white flex flex-col  gap-5">
            ...
            <div className="flex gap-2 select-none min-h-screen-1/2 place-items-center bg-black p-8 rounded-md w-fit m-auto"> <p>Loading results</p> <BsArrowClockwise className="animate-spin h-6 w-6"/></div> : 
