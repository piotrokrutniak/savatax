...
import { FaExclamation, FaPaperPlane } from "react-icons/fa";
...
export function EmailForm({language = "pl"}:{language?: string}){
    ...
    return(
        <div className={`${mounted ? "opacity-100" : "opacity-0 translate-y-1/2"}  flex flex-col gap-4 transition-all duration-500`}>
            ...
            <div className="text-red-500 font-semibold ml-auto mr-0"> <FaExclamation/> {localization[language].emailForm.lblFormValidation} </div>
