...
export function EmailForm(){
    ...
    return(
        <div className="flex flex-col gap-4">
            ...
            <FormInput placeholder="Zacznij pisać..." onChange={UpdateEmail} label={"Tytuł Maila"} validationResult={errors.title} validationMessage="Adres email wymagany."/>
            {/* <FormInput placeholder="Zacznij pisać..." onChange={UpdateEmail} label={"Treść Maila"}/> */}
            <TextArea placeholder="Zacznij pisać..." onChange={UpdateEmail} label={"Treść Maila"} validationResult={errors.body} validationMessage="Adres email wymagany."/>
