...
export function EmailForm(){
    ...
    return(
        <div className="flex flex-col gap-4">
            ...
            <FormInput placeholder="Zacznij pisać..." onChange={UpdateEmail} label={"Tytuł Maila"} validationResult={validation.title} validationMessage="Tytuł maila musi mieć przynajmniej 10 znaków."/>
            {/* <FormInput placeholder="Zacznij pisać..." onChange={UpdateEmail} label={"Treść Maila"}/> */}
            <TextArea placeholder="Zacznij pisać..." onChange={UpdateEmail} label={"Treść Maila"} validationResult={validation.body} validationMessage="Treść maila musi mieć przynajmniej 10 znaków."/>
