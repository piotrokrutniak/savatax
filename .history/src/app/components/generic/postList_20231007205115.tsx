...
export default function PostList(){
    ...
    return(
        <div className="text-white flex flex-col  gap-5">
            ...
            <div className="flex p-3 gap-2 select-none min-h-screen-1/2 place-items-center justify-items-center"> <p>Loading results</p> <BsArrowClockwise className="animate-spin h-6 w-6"/></div> : 
