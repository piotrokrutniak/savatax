            ...
            <div className="w-full flex">
                <div className="p-2 m-auto w-full flex max-w-7xl justify-between items-center">
                    ...
                    <div id="mobile-body" className="p-8 flex flex-col gap-3">
                        <a href={"/#contact-section"}>
                            <Button className="text-white justify-center w-full bg-slate-500/40 active:bg-slate-500/30" onClick={undefined}>
                                {localization[language].lblContact}
                            </Button>
                        </a>
                        <Link href={"/oferta"}>
                            <Button className="text-white py-3 justify-center w-full bg-slate-500/40 active:bg-slate-500/30" onClick={undefined}>
                                {localization[language].lblOffer}
                            </Button>
                        </Link>
                        <Link href={"/"}>
