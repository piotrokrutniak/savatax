            ...
            <div className="w-full flex">
                <div className="p-2 m-auto w-full flex max-w-7xl justify-between items-center">
                    ...
                    <div className="flex gap-1 h-fit select-none cursor-pointer active:opacity-80 active:pb-0 
                        ...
                        <h1 className={`${scrollY > 0 ? "fill-blue-400 bg-clip-text bg-blue-400" : "fill-white"} text-2xl font-bold text-transparent bg-clip-text bg-blue-400 group-hover:bg-gradient-to-r from-blue-300 to-blue-400 transition-all`}>Savatax</h1>
                    </div>
                    </Link>
