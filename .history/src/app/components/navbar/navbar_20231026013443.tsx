...
function DropDown({languages, language, setLanguage, scrollY}:{languages: any[], language: string, setLanguage: Dispatch<SetStateAction<"pl" | "en">>, scrollY: number}){
    ...
    return(
        <div className="relative">
            ...
            <div className={`${opened ? "h-[80px]" : "h-0"} overflow-hidden w-full outline outline-1 outline-slate-400/10 bg-white text-black shadow-lg absolute top-14 md:top-16 right-0 rounded-lg transition-all`}>
