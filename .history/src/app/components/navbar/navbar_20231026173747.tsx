...
function DropDown({languages, language, setLanguage, scrollY}:{languages: any[], language: string, setLanguage: Dispatch<SetStateAction<"pl" | "en">>, scrollY: number}){
    ...
    return(
        <div className="relative">
            ...
            <div className={`${opened ? "bg-blue-500 hover:bg-gradient-to-br from-blue-500 via-blue-500 to-blue-400" : (scrollY > 0 ? "bg-black" : "bg-black/30 hover:bg-black/40")} hover:shadow-lg w-20 p-3 md:p-3 rounded-lg text-white flex place-items-center gap-2 cursor-pointer justify-between max-md:text-sm transition-all`}
