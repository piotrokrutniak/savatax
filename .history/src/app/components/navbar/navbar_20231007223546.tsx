            ...
            <div className="w-full flex bg-slate-700/50 ">
                <div className="p-2 m-auto w-full flex max-w-7xl justify-between items-center">
                    ...
                    <div id="mobile-body" className="p-8 flex flex-col gap-3">
                        <Button className="text-white w-full bg-slate-200/10 active:bg-blue-100/5 hover:bg-blue-200/10 flex" onClick={undefined}>
                            <p className="mx-auto">Home</p>
                        </Button>
                        <Button className="text-white w-full bg-slate-200/10 active:bg-blue-100/5 hover:bg-blue-200/10" onClick={undefined}>
                            <p className="mx-auto">Posts</p>
                        </Button>
                        <Button className="text-white w-full bg-slate-200/10 active:bg-blue-100 hover:bg-blue-200/80" onClick={undefined}>
