        ...
        <div className="bg-black/80 sticky top-0 z-20 backdrop-blur-xl">
            <div className="w-full flex bg-slate-700/50 ">
                <div className="p-2 m-auto w-full flex max-w-7xl justify-between items-center">
                    ...
                    <div id="mobile-body" className="p-8 flex flex-col gap-2">
                        <Button className="text-white bg-transparent w-full active:bg-slate-100/5 hover:bg-slate-200/10 flex" onClick={undefined}>
                            <p className="mx-auto">Home</p>
                        </Button>
                        <Button className="text-white bg-transparent w-full active:bg-slate-100/5 hover:bg-slate-200/10" onClick={undefined}>
