...
function DropDown(){
    ...
    return(
        <div className="relative">
            ...
            <div className={`${opened ? "h-24" : "h-0"} overflow-hidden w-44 bg-white text-black shadow-lg absolute top-16 right-0 rounded-lg transition-all`}>
...
function DropdownOption({value, label}:{value: string, label: string}){
    return(
        <div className="p-2 bg-black">{label}</div>
    )
}