...
function DropDown({languages, language, setLanguage, scrollY}:{languages: any[], language: string, setLanguage: Dispatch<SetStateAction<"pl" | "en">>, scrollY: number}){
    ...
    return(
        <div className="relative">
            ...
            <div className={`${scrollY > 0 ? "bg-black/50 md:bg-black" : "bg-black/30"} w-20 p-3 md:p-3 rounded-lg text-white flex place-items-center gap-2 cursor-pointer justify-between max-md:text-sm`}
