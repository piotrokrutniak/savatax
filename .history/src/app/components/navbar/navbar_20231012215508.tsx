            ...
            <div className="w-full flex">
                <div className="p-2 m-auto w-full flex max-w-7xl justify-between items-center">
                    ...
                    <div className="flex gap-1 h-fit select-none cursor-pointer active:opacity-80 active:pb-0 
                        ...
                        <FaPaperPlane className="h-full w-6 mt-1 fill-blue-400 group-hover:fill-vermilion-400"/>
                        <h1 className="text-2xl font-bold text-transparent bg-clip-text bg-blue-400 hover:bg-gradient-to-r from-vermilion-400 to-vermilion-500 transition-all">Send.it</h1>
                    </div>
                    </Link>
