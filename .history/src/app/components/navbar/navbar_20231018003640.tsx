...
function DropDown({languages, language, setLanguage}:{languages: any[], language: string, setLanguage: Dispatch<SetStateAction<"pl" | "en">>}){
    ...
    return(
        <div className="relative">
            ...
            <div className="w-20 p-3 md:p-3 bg-transparent border-2 border-black rounded-lg text-white flex place-items-center gap-2 cursor-pointer justify-between max-md:text-sm"
