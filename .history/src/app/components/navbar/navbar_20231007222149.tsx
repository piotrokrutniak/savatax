    ...
    return(
        <div className="bg-black/80 sticky top-0 z-20 backdrop-blur-xl">
            <div className="w-full flex bg-slate-700/50 ">
                <div className="p-1 m-auto w-full flex max-w-7xl justify-between items-center">
                    <Link href="/">
                    <div className="flex gap-1 h-fit select-none cursor-pointer active:opacity-80 active:pb-0 
                        ...
                        <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-white hover:bg-gradient-to-r from-vermilion-400 to-vermilion-500 transition-all">Send.it</h1>
                    </div>
                    </Link>
