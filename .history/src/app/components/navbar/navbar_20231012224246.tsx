...
export default function NavBar(){
    ...
    return(
        <div className="bg-white sticky top-0 z-20 backdrop-blur-xl">
            <div className="bg-blue-400 w-full p-2 "> 
                <div className="text-white  max-w-7xl m-auto font-semibold opacity-90 flex gap-5">
            ...
            <div className="w-full flex">
                <div className="p-2 m-auto w-full flex max-w-7xl justify-between items-center">
                    ...
                    <div className="flex gap-1 h-fit select-none cursor-pointer active:opacity-80 active:pb-0 
                        ...
                        <FaCoins className="h-full w-6 mt-1 fill-blue-400 group-hover:fill-blue-300"/>
                    ...
                    <div className="hidden text-lg gap-4 md:flex text-black">
                        <Link href={"/kontakt"}>
                            <Button className="bg-transparent active:opacity-50" onClick={undefined}>
                                {localization["pl-PL"].lblContact}
                            </Button>
                        </Link>
                        <Link href={"/oferta"}>
                            <Button className="bg-transparent active:opacity-50 hover:text-blue-400" onClick={undefined}>
