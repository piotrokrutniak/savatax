...
import DropdownOption from "../generic/dropdown"
...
function DropDown(){
    ...
    return(
        <div className="w-28 p-3 bg-black rounded-lg text-white flex place-items-center gap-2 cursor-pointer relative">
            <div>
                English
            </div>
            <BsChevronDown/>

            <div className="w-44 h-36 bg-white shadow-lg absolute top-16 right-0 rounded-lg"></div>
        </div>
    )
}