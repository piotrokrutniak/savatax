            ...
            <div className="w-full flex">
                <div className="p-2 m-auto w-full flex max-w-7xl justify-between items-center">
                    ...
                    <div className="hidden text-lg gap-4 md:flex text-black">
                        <Link href={"/kontakt"}>
                            <Button className=" bg-transparent active:bg-slate-100/5 hover:text-sky-400 hover:bg-slate-200/40" onClick={undefined}>
                                {localization["pl-PL"].lblContact}
                            </Button>
                        </Link>
                        <Link href={"/oferta"}>
                            <Button className=" bg-transparent hover:text-sky-400 active:bg-sky-100/5 hover:bg-sky-200/10" onClick={undefined}>
