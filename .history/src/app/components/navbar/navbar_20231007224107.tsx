            ...
            <div className="w-full flex bg-slate-700/50 ">
                <div className="p-2 m-auto w-full flex max-w-7xl justify-between items-center">
                    ...
                    <div id="mobile-body" className="p-8 flex flex-col gap-3">
                        ...
                        <Button className="text-white w-full border-2 border-white/50 active:border-green-500/80 hover:border-green-500/80 bg-transparent active:bg-green-500/80 hover:bg-green-500/80" onClick={undefined}>
                            <p className="mx-auto">Users</p>
                        </Button>
                    </div>
                    </div>
