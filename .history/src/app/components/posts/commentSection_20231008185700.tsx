...
export default function CommentsSection({post, ref, setCommentsOpen}:{
    post: Post;
    ref?: any;
    ...
    return(
      <div className="bg-slate-500/30 w-full overflow-hidden rounded-lg relative h-full" ref={ref}>
        <div id="comments-header" className="p-3 border-b-2 border-slate-400/20 shadow-sm shadow-black/40 w-full flex justify-between place-items-center" ref={ref}>
