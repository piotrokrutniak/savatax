...
export function PostItem({post}:{post: Post}){
      ...
      return(
        <div className="w-full p-4 md:h-48 bg-black hover:bg-slate-500/20 rounded-lg shadow-md shadow-black/40 flex flex-col md:flex-row md:justify-between gap-2 items-center text-white group">
          ...
          <div className="h-fit items-center">
            <div className="flex flex-col w-full justify-between gap-2 text-xl">
