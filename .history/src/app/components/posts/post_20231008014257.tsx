  ...
  return(
    <div className="p-4 bg-black rounded-lg flex flex-col gap-1">
      <div className="flex flex-col gap-3">
        <div className="flex max-sm:flex-col justify-between sm:place-items-center gap-2 p-2">
          <span className="lowercase">{comment.email}</span>
          <Button className="text-sm bg-transparent outline-2 outline-slate-400/30 hover:outline-slate-400/60 outline active:opacity-80 w-fit" onClick={undefined}>
