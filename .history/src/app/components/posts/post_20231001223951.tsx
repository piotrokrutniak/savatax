...
export function PostItem({post}:{post: Post}){
      ...
      return(
        <div className="w-full p-0 :p-4 bg-black hover:bg-slate-500/20 rounded-lg shadow-md overflow-clip shadow-black/40 flex flex-col lg:flex-row md:justify-between gap-4 items-center text-white group transition-colors">
