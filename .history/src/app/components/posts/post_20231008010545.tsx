...
import { BsArrowClockwise, BsReply, BsSendDash, BsSendFill, BsX } from "react-icons/bs";
    ...
    return(
      <div className="bg-slate-500/30 w-full relative h-full">
        ...
        <div className="p-4 border-t-2 relative border-slate-400/20 flex gap-4">
          <FormInput className="w-full" placeholder="Start typing..."/>
          <Button>Comment <BsSendFill/> </Button>
        </div>
      </div>
    )
  }
