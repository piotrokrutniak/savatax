...
export function PostItem({post}:{post: Post}){
      ...
      return(
        <div className="w-full p-4 bg-black hover:bg-slate-500/20 rounded-lg shadow-md overflow-clip shadow-black/40 flex flex-col lg:flex-row md:justify-between gap-6 items-center text-white group transition-colors">
          ...
          <div className="h-fit items-center">
            ...
            <div className="flex flex-row-reverse items-center pt-5">
              <div className="flex place-items-center gap-2 cursor-pointer hover:text-vermilion-400 active:opacity-80">
