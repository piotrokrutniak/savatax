  ...
  function CommentsSection({post}:{post: Post}){
    ...
    return(
      <div className="bg-slate-500/30 w-full h-full">
        <div className="p-3 mb-2 border-b-2 border-slate-400/20 shadow-sm shadow-black/40 w-full flex justify-between place-items-center">
        ...
        <div className="p-4 border-t-2 h-10 border-slate-400/20">
          xd
        </div>
      </div>
    )
