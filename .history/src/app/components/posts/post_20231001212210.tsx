        ...
        <div className="w-full p-0 md:p-4 bg-black hover:bg-slate-500/20 rounded-lg shadow-md overflow-clip shadow-black/40 flex flex-col md:flex-row md:justify-between gap-4 items-center text-white group transition-colors">
          ...
          <div className="h-fit items-center p-4 md:p-0">
            <div className="flex flex-col md:flex-row w-full justify-between gap-2 text-xl">
              ...
              <div className="w-full md:w-fit flex-col mr-0 opacity-80 hover:opacity-100 cursor-pointer hover:text-transparent bg-clip-text bg-gradient-to-r from-vermilion-500 to-vermilion-400">
                <h2 className="flex flex-row-reverse text-lg whitespace-nowrap">{user?.name ?? "Guest"}</h2>
                <h2 className="flex flex-row-reverse font-thin text-base">@{user?.username ?? "Guest"}</h2>
              </div>
            </div>
