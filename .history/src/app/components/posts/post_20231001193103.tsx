...
export function PostItem({post}:{post: Post}){
      ...
      return(
        <div className=" p-4 md:h-48 bg-black hover:bg-slate-500/20 rounded-lg shadow-md shadow-black/40 flex flex-col md:flex-row md:justify-between gap-8 items-center text-white group">
          ...
          <div className="h-fit items-center">
            <div className="flex w-full justify-between items-center gap-5">
              <h1 className="text-xl flex cursor-pointer bg-clip-text w-full whitespace-nowrap overflow-ellipsis overflow-hidden hover:text-transparent bg-gradient-to-r from-vermilion-500 to-vermilion-400">
