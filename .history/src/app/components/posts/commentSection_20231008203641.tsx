...
export default function CommentsSection({post, setCommentsOpen}:{
    ...
    return(
      <div className={`comments-${post.id} bg-slate-500/30 w-full overflow-hidden rounded-lg relative h-full`} id="comments-wrapper">
        <div className="p-3 border-b-2 border-slate-400/20 shadow-sm shadow-black/40 w-full flex justify-between place-items-center">
    ...
    return(
      <div className={`comments-${postId} p-4 bg-black rounded-lg flex flex-col gap-1`}>
        <div className="flex flex-col gap-3">
          <div className={`comments-${postId} flex w-full justify-between place-items-center gap-2 sm:p-2`}>
