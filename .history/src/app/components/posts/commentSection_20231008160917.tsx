...
export default function CommentsSection({post, setCommentsOpen}:{
    ...
    return(
      <div className="bg-slate-500/30 w-full relative h-full">
        ...
        <div className="p-1 sm:p-4 min-h-screen-1/4 max-h-screen-1/2 flex flex-col gap-4 bg-slate-500/30 overflow-y-scroll">
          {loading ?
        ...
        <div className="p-4 border-t-2 relative border-slate-400/20 flex gap-2">
          ...
          <Button onClick={SendComment}> {inputActive || "Comment"} <BsSend className="aspect-square w-6"/> </Button>
        </div>
      </div>
    )
  }
