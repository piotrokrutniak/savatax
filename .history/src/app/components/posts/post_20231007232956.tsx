...
import { FaMugHot, FaCookieBite, FaHamburger, FaFireAlt, FaBookmark, FaRegBookmark, FaImage, FaComment, FaCommentAlt } from 'react-icons/fa'
...
export function PostItem({post}:{post: Post}){
      ...
      return(
        <div className="w-full p-4 bg-black hover:bg-slate-500/20 rounded-lg shadow-md shadow-black/40 flex flex-col lg:flex-row md:justify-between gap-6 items-center text-white group transition-colors">
          <div className='w-full aspect-square active:opacity-80 lg:w-96 h-screen-1/2 lg:h-80 shrink-0 rounded-lg overflow-hidden relative cursor-pointer flex justify-center place-items-center bg-black shadow-sm shadow-black/40'>
          ...
          <div className="h-fit items-center">
            <div className="flex flex-col 2xs:flex-row w-full justify-between text-xl gap-2 2xs:gap-5">
            ...
            <div className="flex relative flex-row-reverse items-center pt-5">
              ...
              {commentsOpen && <div className="w-full absolute top-full h-96 rounded-lg mt-2 bg-black z-20"></div>}
            </div>
          </div>          
        </div>
      )
