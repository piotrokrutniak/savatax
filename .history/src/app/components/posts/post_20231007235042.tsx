...
export function PostItem({post}:{post: Post}){
      ...
      return(
        <div className="w-full p-4 bg-black relative hover:bg-slate-500/20 rounded-lg shadow-md shadow-black/40 flex flex-col md:flex-row md:justify-between gap-6 items-center text-white group transition-colors">
          ...
          <div className="h-fit items-center">
            ...
            <div className="flex relative flex-row-reverse items-center pt-5">
              ...
              {commentsOpen && 
              <div className="w-full absolute top-full h-96 rounded-lg overflow-clip mt-2 bg-black z-20 shadow-md shadow-black/40">
                <CommentsSection/>
              </div>}
          </div>          
        </div>
  ...
  function CommentsSection(){
    return(
      <div className="bg-slate-500/30 w-full h-full p-4"></div>
    )
  }
