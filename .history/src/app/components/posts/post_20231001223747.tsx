...
export function PostItem({post}:{post: Post}){
      ...
      return(
        <div className="w-full p-0 md:p-4 bg-black hover:bg-slate-500/20 rounded-lg shadow-md overflow-clip shadow-black/40 flex flex-col lg:flex-row md:justify-between gap-4 items-center text-white group transition-colors">
          ...
          <div className="h-fit items-center p-4 md:p-0">
            <div className="flex flex-col md:flex-row w-full justify-between text-xl">
              <h1 className="flex place-items-center cursor-pointer bg-clip-text w-full whitespace-break-spaces capitalize 
