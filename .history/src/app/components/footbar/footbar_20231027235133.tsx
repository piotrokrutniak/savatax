...
export default function Footbar(){
    return(
        <footer>
        <div className="w-full bg-blue-400 mt-16 px-4 z-10 text-center text-white flex place-items-center justify-center">
            <div className="w-full flex max-w-6xl py-20 md:px-16">
                <ul className="flex flex-col gap-4 text-start">
                    <li className="flex flex-col">
                        ...
                        <h2 className="text-lg md:text-xl font-semibold opacity-95">Accounting Firm from Warsaw</h2>
                    </li>
                    <li className="flex flex-col md:text-lg">
                        <p className="font-semibold">Na Skraju 20</p>
                        <p className="font-semibold">02-197 Warsaw</p>
