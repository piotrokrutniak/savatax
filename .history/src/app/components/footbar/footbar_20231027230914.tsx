...
export default function Footbar(){
    ...
    const language = cookies.get("preferred-lang") ?? "en"
    return(
        <footer>
            ...
            <div className="w-full flex max-w-6xl py-20 md:px-16">
                <ul className="flex flex-col gap-4 text-start">
                    <li className="flex flex-col">
                        ...
                        <h2 className="text-xl font-semibold opacity-95">{language == "en" ? "Accounting Firm from Warsaw" : "Biuro Rachunkowe = Warszawa"}</h2>
                    </li>
                    <li className="flex flex-col">
