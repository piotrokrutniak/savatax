    ...
    <div className="flex flex-col relative -top-20 gap-32 scroll-smooth">
      ...
      <section id="summary-section" className='max-w-6xl p-4 sm:p-8 mx-auto w-full justify-center md:px-16 rounded-xl flex flex-col gap-5'>
        ...
        <p className="md:leading-8 md:text-lg font-normal ">
          Jesteśmy Savatax - firmą rachunkową z Warszawy, która chce Ci pomóc w prowadzeniu Twojego biznesu. Zajmujemy się rachunkowością małych i średnich firm z różnych branż i wiemy, jak ważne jest dla Ciebie, aby mieć sprawy finansowe pod kontrolą. Dlatego oferujemy Ci pełen zakres usług rachunkowych, takich jak księgowość, rozliczenia podatkowe, kadry i płace, doradztwo finansowe i audyt. Nasz zespół to sami pasjonaci rachunkowości, którzy mają duże doświadczenie i stale się szkolą. Używamy nowoczesnych technologii i systemów informatycznych, które zapewniają bezpieczeństwo i szybkość obsługi. Jesteśmy elastyczni i dostosowujemy się do Twoich potrzeb i oczekiwań.
        </p>
