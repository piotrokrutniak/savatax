  ...
  return (
    <div className="flex flex-col gap-4">
      <section className="w-full h-screen-3/5 bg-gradient-to-t from-black to-black/90 relative text-white">
        <div id="slider-section" className="absolute max-md:px-8 py-8 w-full mx-auto z-10 m-auto bottom-0 shadow-md shadow-black/40 h-full flex place-items-center">
      ...
      <section id="summary-section" className='max-w-6xl p-8 mx-auto w-full justify-center md:p-16 md:py-32 rounded-xl flex flex-col gap-5'>
            ...
            <p className="pt-16">
              ...
              <ul className="md:text-lg p-12 my-12 rounded-lg shadow-inner gap-6 grid grid-auto-fit-md bg-sky-100/40">
                <ListPanel> 
