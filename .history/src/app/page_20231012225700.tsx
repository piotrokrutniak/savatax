  ...
  return (
    <>
      <section className="w-full h-screen-1/2 bg-black relative text-white">
        <div id="top-picks-section" className="max-w-7xl p-8 w-full mx-auto bg-white/10 m-auto md:text-3xl">
            XDDDD
        </div>
        <Image loading="lazy" layout="fill" objectFit="cover" src={SplashArt} alt="Album thumbnail" className="opacity-80 -z-10 absolute aspect-square w-full h-full"/>
      </section>
