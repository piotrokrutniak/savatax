...
import { FaBook, FaChartArea, FaChartBar, FaChartLine, FaChartPie, FaCoins, FaFileInvoice, FaFileInvoiceDollar, FaMoneyBill, FaMoneyBillAlt, FaMoneyCheck, FaPiggyBank } from 'react-icons/fa'
