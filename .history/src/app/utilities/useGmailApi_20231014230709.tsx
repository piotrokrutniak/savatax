...
const ConfirmationBody = (email: Email) => {
    return(`
        ...
        <div style="margin-top: 0.25rem; font-size: 1.5rem; font-weight: 700; color: transparent; background-clip: text; background-image: linear-gradient(to right, var(--tw-gradient-stops)); background-color: #60A5FA;">
            <p>Savatax</p>
        </div>
        </div>`
