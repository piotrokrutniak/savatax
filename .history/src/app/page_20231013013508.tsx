  ...
  return (
    <div className="flex flex-col gap-4">
      <section className="w-full h-screen-3/5 bg-gradient-to-t from-black to-black/90 relative text-white">
        <div id="slider-section" className="absolute max-md:px-8 py-8 w-full mx-auto z-10 m-auto bottom-0 shadow-md shadow-black/40 h-full flex md:place-items-center">
