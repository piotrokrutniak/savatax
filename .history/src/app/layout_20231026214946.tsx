...
function CookiesPopUp(){
  return(
    <div className="w-96 bg-blue-500 rounded-lg shadow-md shadow-black/40 fixed bottom-8 right-8 p-6 text-white">
      ...
      <Button className="bg-white hover:text-blue-400 text-blue-500 mt-4 font-semibold">Got it</Button>
    </div>
  )
}