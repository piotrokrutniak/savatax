  ...
  return (
    <div className="flex flex-col gap-4">
      <section className="w-full h-screen-1/2 bg-gradient-to-t from-black to-black/90 relative text-white">
        <div id="slider-section" className="absolute p-8 w-full mx-auto z-10 m-auto bottom-0">
      ...
      <section id="summary-section" className='max-w-6xl mx-auto w-full h-screen justify-items-center place-items-center md:p-16 rounded-xl flex flex-col gap-5'>
            ...
            <p className="pt-16">
              ...
              <ul className="md:text-lg list-disc pl-6 pt-4 flex flex-col gap-3">
