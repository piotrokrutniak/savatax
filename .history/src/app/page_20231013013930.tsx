  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <section id="summary-section" className='max-w-6xl p-8 mx-auto w-full justify-center md:p-16 md:py-32 rounded-xl flex flex-col gap-5'>
            <h1 className="md:text-3xl text-xl font-bold text-blue-400 md:p-4">Rachunkowość bez stresu</h1>
            ...
            <p className="pt-16">
              <span className="md:leading-8 text-xl md:text-2xl font-semibold opacity-90 p-4">
