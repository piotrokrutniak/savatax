  ...
  return (
    <div className="flex flex-col gap-4">
      <section className="w-full h-screen-1/2 bg-gradient-to-t from-black to-black/90 relative text-white">
        ...
        <div className="w-full sticky h-screen-1/2 top-0 z-0">
          <Image loading="lazy" layout="fill" objectFit="cover" src={SplashArt} alt="Album thumbnail" className="opacity-40  w-full h-full"/>
        </div>
      </section>
      <section id="summary-section" className='max-w-6xl mx-auto w-full md:p-16 rounded-xl flex flex-col gap-5'>
            ...
            <p className="pt-16">
              ...
              <ul className="md:text-lg list-disc pl-8 pt-2 gap-2">
