...
export default function Home(pageData: {params: {countryCode: keyof typeof Localization}, searchParams: any}) {
  ...
  return (
    <>
    <section className="w-full pt-32 top-0 relative bg-blue-400 bg-gradient-to-t from-blue-400 to-blue-600 flex place-items-center shadow-lg">
    ...
    <section className="w-full h-20 -top-20 relative bg-black">
