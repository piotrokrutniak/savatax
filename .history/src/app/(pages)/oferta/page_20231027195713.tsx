    ...
    <section className="w-full p-4 md:p-8 -top-20 relative">
      <div className="max-w-6xl w-full relative mx-auto py-16">
        <div className="flex gap-4">
          <h1 className="md:text-3xl text-2xl font-bold text-blue-400 md:p-4 bg-slate-100 rounded-t-lg">{Localization[language].servicesPage.services[0].header}</h1>
          <h1 className="md:text-3xl text-2xl font-bold text-blue-400 md:p-4 bg-slate-100 rounded-t-lg">{Localization[language].servicesPage.services[1].header}</h1>
          <h1 className="md:text-3xl text-2xl font-bold text-blue-400 md:p-4 bg-slate-100 rounded-t-lg">{Localization[language].servicesPage.services[2].header}</h1>
        </div>
...
function ServiceTab({label, index, activeIndex}:{label: string, index: number, activeIndex: number}){
  return(
    <h1 className={`${index == activeIndex ? "bg-blue-400 text-white" : "bg-slate-100 text-blue-400"} md:text-3xl text-2xl font-bold  md:p-4 rounded-t-lg`}>{label}</h1>
  )
}