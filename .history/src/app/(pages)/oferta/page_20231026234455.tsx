...
export default function Home(pageData: {params: {countryCode: keyof typeof Localization}, searchParams: any}) {
  ...
  return (
    <>
    <section className="w-full h-screen-2/3 top-0 absolute bg-blue-400 pt-16 flex place-items-center">
    ...
    <section className="w-full h-screen-2/3 top-0 relative bg-blue-400 pt-16 flex place-items-center">
      <div className="max-w-6xl w-full mx-auto">
        <div className="flex">
          <OfferPanel/>
        </div>
