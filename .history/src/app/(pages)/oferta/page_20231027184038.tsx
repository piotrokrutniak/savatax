...
export default function Home(pageData: {params: {countryCode: keyof typeof Localization}, searchParams: any}) {
  ...
  return (
    <>
    <section className="w-full pt-20 lg:pt-32 -top-20 relative bg-blue-400 bg-gradient-to-t from-blue-400 to-blue-600 flex place-items-center shadow-lg">
      <div className="max-w-6xl w-full relative mx-auto lg:py-16 overflow-x-hidden">
        <div className="flex relative w-full h-screen-3/4 lg:h-96 transition-all duration-300" style={{transform: `translateX(-${activeIndex * 100}%)`}}>
