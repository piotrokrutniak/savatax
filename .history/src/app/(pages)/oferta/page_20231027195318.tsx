    ...
    <section className="w-full p-4 md:p-8 -top-20 relative">
      <div className="max-w-6xl w-full relative mx-auto py-16">
        <div className="flex gap-4">
          ...
          <h1 className="md:text-3xl text-2xl font-bold text-blue-400 md:p-4 bg-slate-100">{Localization[language].servicesPage.services[1].header}</h1>
          <h1 className="md:text-3xl text-2xl font-bold text-blue-400 md:p-4 bg-slate-100">{Localization[language].servicesPage.services[2].header}</h1>
        </div>
