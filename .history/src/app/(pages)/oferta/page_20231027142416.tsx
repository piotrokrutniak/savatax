...
export default function Home(pageData: {params: {countryCode: keyof typeof Localization}, searchParams: any}) {
  ...
  return (
    <>
    <section className="w-full py-32 top-0 relative bg-blue-400 bg-gradient-to-t from-blue-400 to-blue-600 flex flex-col place-items-center shadow-lg">
      <div className="max-w-6xl w-full relative mx-auto py-16 overflow-visible">
    ...
    <div className='flex justify-center relative gap-2 bottom-0 transition-all'>
