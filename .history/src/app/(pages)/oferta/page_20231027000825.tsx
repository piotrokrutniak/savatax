...
export default function Home(pageData: {params: {countryCode: keyof typeof Localization}, searchParams: any}) {
  ...
  return (
    <>
    <section className="w-full py-32 top-0 absolute bg-blue-400 bg-gradient-to-t from-blue-400 to-blue-600 flex place-items-center">
      <div className="max-w-6xl w-full mx-auto">
        <div className="flex relative w-full h-80 py-16">
          <OfferPanel bullets={[
...
function OfferPanel({bullets}:{bullets: string[]}){
  return(
    <div className="flex absolute h-full w-full place-items-center gap-10">
      <div className="h-96 rounded-lg bg-white aspect-square"></div>
      <div className="flex flex-col text-white gap-4">
        <h1 className="text-4xl font-bold">Rachunkowość</h1>
        <ul className="text-xl font-semibold pl-5">
