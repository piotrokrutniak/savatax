  ...
  return (
    ...
    <section className="w-full -top-20 relative">
      <div className="max-w-6xl w-full relative mx-auto py-16">
        ...
        <h2 className="md:text-xl text-lg font-semibold md:p-4">Prowadzenie ksiąg rachunkowych</h2>
        ...
        <h2 className="md:text-xl text-lg font-semibold md:p-4">Prowadzenie księgi przychodów i rozchodów</h2>
        <p className="md:leading-8 md:text-lg font-normal "></p>
        <h2 className="md:text-xl text-lg font-semibold md:p-4">Prowadzenie ewidencji przychodów i rozliczenia podatków</h2>
        <p className="md:leading-8 md:text-lg font-normal "></p>
        <h2 className="md:text-xl text-lg font-semibold md:p-4">Sporządzanie i konsolidacja sprawozdań finansowych</h2>
        <p className="md:leading-8 md:text-lg font-normal "></p>
      </div>
    </section>
    </>
