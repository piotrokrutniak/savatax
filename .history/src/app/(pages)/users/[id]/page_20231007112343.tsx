...
export default function UserPage(pageData: {params: {id: number}, searchParams: any}){
    ...
    return(
        <>
        <section id="header-section" className='max-w-7xl flex flex-col gap-5 bg-black/90 m-auto w-full  rounded-xl mt-4 shadow-md shadow-black/40'>
            ...
            <div className="flex flex-col gap-4 p-8 bg-slate-50/70">
