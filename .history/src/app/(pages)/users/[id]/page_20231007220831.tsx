...
export default function UserPage(pageData: {params: {id: number}, searchParams: any}){
    ...
    return(
        <>
        <section id="header-section" className='max-w-7xl flex flex-col overflow-hidden gap-5 bg-black/90 m-auto w-full  rounded-xl shadow-md shadow-black/40 text-white'>
        ...
        <section id="albums-section" className='max-w-7xl flex flex-col overflow-hidden gap-5 bg-black/90 m-auto w-full rounded-xl shadow-md shadow-black/40 text-white'>
        ...
        <section id="posts-section" className='max-w-7xl flex flex-col overflow-hidden gap-5 bg-black/90 m-auto w-full rounded-xl shadow-md shadow-black/40 text-white'>
            <div className="flex flex-col gap-4 p-4 md:p-8 bg-slate-500/20">
                <h1 className="text-xl p-1 font-bold flex justify-between place-items-center">
