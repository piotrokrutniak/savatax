...
export default function UserPage(pageData: {params: {id: number}, searchParams: any}){
    ...
    return(
        <>
        <section id="header-section" className='max-w-7xl flex flex-col overflow-hidden bg-black/90 m-auto w-full rounded-xl shadow-md shadow-black/40 text-white p-4 sm:p-8 relative'>
