    ...
    return(
        ...
        <section id="header-section" className='max-w-7xl flex flex-col overflow-hidden gap-5 bg-black/90 m-auto w-full rounded-xl shadow-md shadow-black/40 text-white p-4 sm:p-8 relative'>
            ...
            <div id="photo-section" className="w-full h-full sm:h-screen-1/2 aspect-square relative">
                {selectedPhoto && selectedPhoto.url  == "" ? <FaImage className="w-20 h-20 md:w-12 opacity-30 flex"/> : <Image layout="fill" objectFit="contain" src={selectedPhoto?.url ?? ""} alt="Album thumbnail" className="aspect-square h-full"/>}
            </div>
