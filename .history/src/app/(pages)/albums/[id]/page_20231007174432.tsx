...
export default function UserPage(pageData: {params: {id: number}, searchParams: any}){
    ...
    return(
        ...
        <section id="header-section" className='max-w-7xl flex flex-col overflow-hidden gap-8 relative bg-black/90 m-auto w-full rounded-xl mt-4 shadow-md shadow-black/40 text-white p-8 relative'>
