...
function GalleryPanel({photo, setPhoto}:{
    ...
    return(
        <div className="relative aspect-square">
            <Image loading="lazy" layout="fill" objectFit="contain" src={photo.thumbnailUrl ?? ""} alt="Album thumbnail" className="max-h-96 h-full cursor-pointer active:opacity-80 transition-all" onClick={() => setPhoto(photo)}/>
        </div>
    )
}